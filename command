apt-copynumber-onco-ssa \
    --log-file results/apt-copynumber-onco-ssa.log \
    --out-dir results \
    --temp-dir results/temp \
    --force false \
    --keep-intermediate-data false \
    --keep-combined-cels false \
    --snp-qc-snp-list libraryfiles/OncoScan.r1.snplist.txt \
    --reference-file libraryfiles/OncoScan.FFPE.na33.r1.REF_MODEL \
    --y-target -0.8 \
    --nddqc-min-count 2000 \
    --set-analysis-name mip240k \
    --brlmmp-HARD 3 \
    --brlmmp-SB 0.750000 \
    --brlmmp-CM 2 \
    --brlmmp-bins 100 \
    ...
    --brlmmp-MS 0.06 \
    --annotation-file libraryfiles/OncoScan.na33.r1.annot.db \
    --x-probes-file libraryfiles/OncoScan.r1.chrXprobes \
    --y-probes-file libraryfiles/OncoScan.r1.chrYprobes \
    --cel-pairs-file celfiles.txt \
    ...
    --dual-channel-normalization false \
    --ad-outlier-trim 3.0 \
    ...
    --sig-snp-report-filename results/OncoScan.CelPairCheckReport.txt \
    --ap-ad-step 20 \
    --ap-ad-window 100 \
    ...
    --report-file results/QCReport.txt \
    --cychp-output false \
    --text-output false \
    --oschp-output true \
